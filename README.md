# **All in One Accessibility® - Wagtail Accessibility Plugin**

## **Free WCAG, ADA, EAA accessibility plugin for Wagtail websites!**

This [Free Wagtail accessibility plugin](https://www.skynettechnologies.com/wagtail-ada-widget) - adds an accessible experience for users with visual, auditory, motor, or cognitive disabilities. It supports assistive technologies, offers customizable updates, and enhances overall usability according to WCAG 2.1, 2.2, ADA, EAA, Section 508, France RGAA, California Unruh, European EAA EN 301 549, UK Equality Act, Spain UNE 139803:2012, Australian DDA, Israeli Standard 5568, Ontario AODA, Canada ACA, German BITV, Brazilian Inclusion Law (LBI 13.146/2015), JIS X 8341 (Japan), Italian Stanca Act, Indian RPwD Act, Switzerland DDA and other [accessibility standards](https://www.skynettechnologies.com/accessibility-standards).
...
**Core Features - What you get with free accessibility Wagtail widget?**
...
- Dynamic free Wagtail accessibility module customization including colors, size, icon, and position
- Reading mask
...
**This free accessibility Wagtail plugin is a great fit for:**

- Businesses, developers, agencies, content teams, ecommerce brands, educational institutions, and public-facing organizations using Wagtail who want to improve WCAG accessibility, usability, and user experience quickly without complex development.

**Why select free Wagtail WCAG accessibility module - All in One Accessibility?**
...
- Integrates smoothly with most Wagtail site setups.
...
| Wagtail        | 5.2, 6.0, 6.1, 6.2, 6.3, 6.4, 7.0, 7.1, 7.2, 7.3, 7.4          |
| Plugin Version | 2.2.3                                                         |

`install_requires` is intentionally kept wide (`Django>=4.2,<6.1`,
`wagtail>=5.2,<8.0`) so this plugin doesn't block `pip`'s resolver from
picking whatever current Django/Wagtail combination the rest of your
project needs. Not every Django/Wagtail pair in that range is compatible
with *each other* though - Wagtail dropped Django 4.2 support as of
Wagtail 7.4, and Django 6.0 requires Python 3.12+. Match the pair to
[Wagtail's own compatible Django/Python table](https://docs.wagtail.org/en/stable/releases/upgrading.html#compatible-django-python-versions),
reproduced here for the versions this plugin has been tested against:

#### Python 3.13 / 3.14
- **Django 6.0**: Compatible with **Wagtail 7.4, 7.3, 7.2**
- **Django 5.2**: Compatible with **Wagtail 7.4, 7.3, 7.2, 7.1, 7.0**
- **Django 5.1**: Compatible with **Wagtail 7.2, 6.4, 6.3, 6.2, 6.1, 6.0**

#### Python 3.10 / 3.11
- **Django 5.2**: Compatible with **Wagtail 7.4, 7.3, 7.2, 7.1, 7.0**
- **Django 5.1**: Compatible with **Wagtail 7.2, 6.4, 6.3, 6.2, 6.1, 6.0**
- **Django 4.2**: Compatible with **Wagtail 7.3, 7.2, 7.1, 7.0, 6.4, 6.3, 6.2, 6.1, 6.0, 5.2**

> **Notes:**
> - Django 6.0 requires Python 3.12 or higher, and (as of Wagtail 7.4)
>   also requires dropping Django 4.2 - if you're on Wagtail 7.4+, use
>   Django 5.2 or 6.0.
> - Wagtail 8.0 is still in development at the time of writing and isn't
>   pinned to yet; once released, bump the upper bound in your own
>   project once you've verified compatibility.


### **SECURITY & PRIVACY NOTES**

- This Free Accessibility Wagtail module follows several data and application security practices, including ISO 9001:2015 & ISO 27001:2013, GDPR, CCPA, COPPA, HIPAA, and SOC 2 Type II.
...
For more details, visit [**Wagtail accessibility plugin**](https://www.skynettechnologies.com/wagtail-ada-widget)**.**

---

## **FAQS**

**Is this AI accessibility extension compatible with Wagtail multisite?**

Yes.

**Does this free Wagtail accessibility plugin support multilingual Wagtail sites?**

Yes. It supports 190+ languages.

**How can I upgrade from free to Paid Wagtail accessibility widget for upgrading accessibility features?**

Upgrade to Paid subscription with **90 plus advanced features** and take website's accessibility to the next level. Checkout the steps for upgrading [free to paid Wagtail accessibility widget](https://www.skynettechnologies.com/blog/upgrade-from-all-in-one-accessibility-free-widget-to-premium-version)**.**

**What additional features are available in the paid version of Wagtail WCAG ADA EAA plugin?**

The paid version of Wagtail accessibility widget includes following features like screen reader, voice navigation, talk & type, virtual keyboard, accessibility profiles tailored for different users with disabilities group, Libras (Brazilian sign language), dictionary search, multi-language support (190+ languages), and many more. Pricing starts from \$25 / month. Explore more information about [accessibility widget](https://www.skynettechnologies.com/all-in-one-accessibility) and buy now.
...
### Step 4 — Add the widget script tag to your Wagtail base template

Open your site's base template. This is typically:

- `templates/base.html` (default Wagtail project template)
...
### Step 7 — Configure in Wagtail Admin

Visit your Wagtail admin and click **All in One Accessibility** in the sidebar:

```
http://your-site.com/admin/
```

Configure widget color, position, icon type, and size, then click **Save**.
...
Open your site's homepage. The floating accessibility widget should appear in the corner
...
- [**Wagtail Accessibility Plugin**](https://www.skynettechnologies.com/wagtail-ada-widget)
- [**Wagtail WCAG compliance accessibility - Features Guide**](https://www.skynettechnologies.com/sites/default/files/accessibility-widget-features-list.pdf)
...
**[Wagtail manual accessibility audit](https://www.skynettechnologies.com/website-accessibility-audit)**

- Enhance inclusivity and user experience by evaluating Wagtail website's accessibility by [web accessibility consultant](https://www.skynettechnologies.com/web-accessibility-consultant).
...
**Accessibility Wagtail Widget Paid Add-ons**
...
[**Instant live site translations**](https://www.skynettechnologies.com/all-in-one-accessibility/addons#accessibility-widget-add-ons) **for Wagtail sites**

Translate Wagtail site into over 190 languages instantly to enhance accessibility for non-native speakers, individuals with language acquisition difficulties, and those with learning disabilities.

[**Modify Accessibility Menu**](https://www.skynettechnologies.com/all-in-one-accessibility/addons#accessibility-widget-add-ons) **for Wagtail websites**
...
**Wagtail Accessibility Partnership Opportunities**

[**Wagtail accessibility agencies partnership**](https://www.skynettechnologies.com/agency-partners)

Partner with us as an agency to provide comprehensive Wagtail ADA, EAA, WCAG accessibility solutions to clients. Get access to exclusive resources, training, and support to implement and manage accessibility features effectively.

[**Wagtail accessibility affiliate partnership**](https://www.skynettechnologies.com/affiliate-partner)
...
For more details, explore [**Wagtail accessibility partnership opportunities**](https://www.skynettechnologies.com/partner-program)
